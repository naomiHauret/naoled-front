    ...
    for (var _i = 0; _i < _meshIndices.length; _i += 3) {
      ...
      for (var _j = 0; _j < 3; _j++) {
        ...
        if (_side[_A][_B] === undefined && _side[_B][_A] === undefined) {
          ...
          for (var _k = 1; _k < _gaps; _k++) {
            ...
            _positions.push(
              _positions[3 * _A] + _k * _d.x,
              _positions[3 * _A + 1] + _k * _d.y,
              _positions[3 * _A + 2] + _k * _d.z,
            )
      ...
      for (var _k = 2; _k < _gaps; _k++) {
        ...
        for (var _j = 1; _j < _k; _j++) {
          ...
          _positions.push(
            _positions[3 * _fvs[_k][0]] + _j * _d.x,
            _positions[3 * _fvs[_k][0] + 1] + _j * _d.y,
            _positions[3 * _fvs[_k][0] + 2] + _j * _d.z,
          )
